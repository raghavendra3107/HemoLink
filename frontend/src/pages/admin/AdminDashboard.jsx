      ...
      <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Comprehensive overview of HemoLink
                </p>
              </div>
            </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
            <div className="cursor-pointer" onClick={() => window.location.href = '/admin/donors'}>
              <StatCard
            ...
            <div className="cursor-pointer" onClick={() => window.location.href = '/admin/facilities'}>
              <StatCard
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <QuickActionCard
              ...
              title="Manage Donors"
              description="View, edit, or remove donors from HemoLink"
              href="/admin/donors"
            />
            ...
            <QuickActionCard
              ...
              description="View and manage pending facility verifications"
