...
import HeroBloodCells from "../components/HeroBloodCells";
...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-red-50 mt-10">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-r from-red-800 to-red-950 text-white">
        <HeroBloodCells />
