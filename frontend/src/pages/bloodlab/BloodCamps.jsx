                  ...
                  >
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <div className="flex gap-1">
                        <Link
                          to={`${location.pathname}/${camp._id}/registrations`}
                          className="text-blue-600 hover:text-blue-700 p-1 transition-colors flex items-center gap-1 text-sm font-medium mr-2"
