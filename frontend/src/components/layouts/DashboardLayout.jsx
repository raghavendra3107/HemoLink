  ...
  const menuConfig = {
    ...
    hospital: {
      ...
      items: [
        ...
        { path: "/hospital/camps", label: "Camps", icon: Calendar, badge: null },
        ...
        >
          ...
          {!sidebarCollapsed && (
            <div className="p-4 border-t border-red-100">
              ...
              >
                <p className="text-sm font-semibold">HemoLink</p>
