...
export default function DonorRegisterForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    // --- Mock OTP Logic ---
    const OTP_LIST = [
      "100000", "111111", "222222", "333333", "444444", 
      "555555", "666666", "777777", "888888", "999999",
      "123456", "654321", "101010", "202020", "303030",
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center py-8 px-4 outline-0">
      {/* Background Image Wrapper */}
      <div 
        className="fixed inset-0 z-0 bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: `url('/images/donor_register_bg.png')` }}
      >
