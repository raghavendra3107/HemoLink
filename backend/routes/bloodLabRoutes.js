...
import { getRecentDonations, markDonation, searchDonor, getCampRegistrations, updateRegistrationStatus } from "../controllers/donorController.js";
...
router.put("/camps/registrations/:id/status", protectFacility, updateRegistrationStatus); 
