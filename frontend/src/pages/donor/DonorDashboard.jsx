...
const DonorDashboard = () => {
  ...
  return (
    <div className="min-h-screen relative p-6">
      ...
      <DonorPortalBackground />

      <div className="relative z-10 max-w-7xl mx-auto">
        {/* Header */}
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 bg-white/80 p-6 rounded-2xl shadow-sm border border-red-50 backdrop-blur-lg">
          <div>
          ...
          <button
            ...
            disabled={refreshing}
            className="mt-4 lg:mt-0 flex items-center gap-2 px-5 py-2.5 bg-red-600 text-white shadow-lg shadow-red-200 rounded-xl hover:bg-red-700 transition-all font-semibold disabled:opacity-50"
          >
...
const DonationHistoryItem = ({ donation }) => (
  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
    <div className="flex items-center gap-3">
      ...
      <div>
        <p className="font-medium text-gray-800">
           ...
           {donation.city && <span className="text-gray-500 font-normal ml-1">- {donation.city}</span>}
        </p>
    ...
    <div className="text-right">
      <span className="font-bold text-gray-800">{donation.quantity || 1} {donation.quantity > 50 ? "ml" : "Unit(s)"}</span>
